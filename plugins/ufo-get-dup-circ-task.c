...
/**
 * SECTION:ufo-get-dup-circ-task
 * @Short_description: Merge list of ring coordinates from different patterns
 * into one unique list of coordinates, averaging neighbooring rings.
 * @Title: get_dup_circ
 *
 */
                               ...
                               UfoRequisition *requisition)
{
    ...
    priv->coord = malloc (sizeof (UfoRingCoordinate) * nb_elt);
