...
static float
array_mean (float *data, int size, float low, float high)
{
    float res = 0.0f;
    unsigned ct = 0;
...
static float
array_std (float *data, int size, float mean, float low, float high)
{
    float res = 0.0f;
    unsigned ct = 0;
...
static int
prepare_test (gfloat* test, gfloat* input, int offset_x, int offset_y,
...
static void
approx_bg (gfloat* test, int size, float* m, float* s)
{
    int ct;
